...
#                                out_hist_cols.append(col_fmt.format(county_name,sl,Kh,d2,temp_type))
                    ...
                    out_stats.append([county_name,datum_type,
                                      np.nanmedian(dist_inland_array),np.nanmean(dist_inland_array),
                                      np.nanmax(dist_inland_array),
                                      np.nanstd(dist_inland_array),dist_inland_array[~np.isnan(dist_inland_array)].shape[0]])
...
out_fname2 = os.path.join(results_dir,'distinland_stats2_{}.csv'.format(active_date))
out_cols2 = ['County','Datum_Model',
             'Median_dist_m','Mean_dist_m','Max_dist_m',
             'Std_dist_m','Count_dist']
